export const abstractDescription = `
  ...
  In this workshop, we would like to focus on the fundamental question of how to measure the complexity of such systems and detect emerging patterns within them. The conference will be held at EPFL Bernoulli Center.
`;
